...
function updateScroller() {
    var scroller = {
        resizeRequest: 0,
        target: document.getElementById("your-scroller-target-id"), // Replace "your-scroller-target-id" with the actual ID of your scroller target
        ease: 0.1, // Adjust this value as needed
        y: 0,
        endY: 0,
        scrollRequest: 0
    };
